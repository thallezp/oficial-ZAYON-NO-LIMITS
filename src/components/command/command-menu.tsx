...
const workspaceLinks = [
  ...
  { href: "/study/tracks", label: "Trilhas de Estudo", icon: Milestone, group: "Estudos" },
  { href: "/study/library", label: "Biblioteca", icon: Library, group: "Estudos" },
  { href: "/study/sessions", label: "Timer de Foco", icon: Timer, group: "Estudos" },
  { href: "/study/reviews", label: "Revisões (Card)", icon: Repeat, group: "Estudos" },
  { href: "/study/planner", label: "Rotina & Blocos", icon: CalendarClock, group: "Estudos" },
